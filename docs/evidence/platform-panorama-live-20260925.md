...
| 5005 ComfyUI | H3 视频试用模板、工作流和“运行”按钮可见，队列 0 | 证明 UI 可达；本轮未重新按“运行”或下载新视频 |
