...
- NOT delivered yet: paid-order-bound media job orchestration, provider video
  lifecycle/cancellation, media usage integration, a qualified production image,
  production WebIDE rollout and end-to-end MoonGate media success. The upstream
  ComfyUI plugin also has a five-minute poll ceiling and incomplete cancellation
  cleanup; its presence alone does not complete the pipeline. No GPU inference
  or Spark acceptance is claimed.
