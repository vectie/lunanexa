...
class VLLMOmniClient:
    ...
    async def generate_video(
        ...
        *,
        ...
        # LunaNexa: forwarded straight to run_video_job so a caller can drive a
        # progress bar. It must be declared explicitly: this signature ends in
        # **extra_body, so an undeclared keyword would be posted as a form field.
